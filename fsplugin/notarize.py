...
shell("rm -f build/notarize.zip")
shell("zip -r build/notarize.zip \"{}\"".format(app))
result = shell("xcrun altool --notarize-app -t osx " \
"-f build/notarize.zip " \
